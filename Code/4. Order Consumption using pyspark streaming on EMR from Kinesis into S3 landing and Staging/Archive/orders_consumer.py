...
# dynamodb part starts

print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
orders_df.createOrReplaceGlobalTempView("orders_tbl")

orders_audit_df = spark.sql("SELECT 'landing_layer' as layer, count(*) as num_recs FROM global_temp.orders_tbl")

orders_audit_df.write.mode("overwrite").saveAsTable("TEMPTODYNAMO")
